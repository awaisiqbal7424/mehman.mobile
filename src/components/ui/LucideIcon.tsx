import {
  ...
  MapTrifold, Megaphone, MagnifyingGlass, Minus, PaperPlaneTilt, PencilSimple, Plus, Receipt,
  ArrowClockwise, FileText, LockKey, Scales, SealCheck, Shield, Sparkle, Star, Tag, Timer, Trash, User, Users,
